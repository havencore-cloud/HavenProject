...
import time
from pulse.sell_decision import should_sell
from pulse.trade_logger import log_trade
from pulse.risk_manager import RiskManager
from pulse.wallet_manager import get_trade_wallet, get_vault_wallet, deposit_to_trade_wallet
from pulse.onchain.onchain_price import get_token_price_usd
from pulse.trade_executor import TradeExecutor
from pulse.config import DRY_RUN_MODE, MONITORED_MODE, STOP_LOSS_PERCENTAGE, TRADE_AMOUNT, VALID_USER_TOKENS
from pulse.analytics.analytics_core import set_open_position, update_metrics, clear_open_position
...
class StrategyController:
    def __init__(self, trading_api=None):
        ...
        from pulse.strategy_engine import StrategyEngine
